...
public class UberGeoHash {
	...
	public UberGeoHash(double lat, double lng) {
	 ...
	 * // (-90, 90),(0.0, 90),(0.0, 45),(22.5, 45)...(39.9188, 39.9243)
	 *
	*/
	...
	public static void main(String[] args) {
		...
		UberGeoHash g = new UberGeoHash(40.222012, 116.248283);// wx4sv61q
		System.out.println("GeoHash for ("+g.location.getLat()+", "+g.location.getLng()+") is :\n"+g.getGeoHashBase32());
		//System.out.println(JsonUtil.parseJson(g.getGeoHashBase32For9()));
		System.out.println("9 Neighboring GeoHash: \n"+(g.getGeoHashBase32For9()));
	}
